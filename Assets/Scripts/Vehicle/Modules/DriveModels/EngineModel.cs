...
{
    /// <summary>
    /// Model for calculating engine behavior including RPM, power, torque, and wheel force.
    ...
    public sealed class EngineModel
    {
        ...
        /// in EngineDriveModel uses the direct chain: engineRPM → torque → wheelTorque → wheelForce.
        /// </summary>
        /// <param name="speed">Vehicle speed in m/s. Can be negative for reverse.</param>
        /// <param name="throttle">Throttle input (0-1).</param>
